jQuery(document).ready(function($) {
  ...
  url : "http://api.wunderground.com/api/1e87c7e6b0a2bb1e/forecast10day/q/Japan/Sapporo.json",
  dataType : "jsonp",
  ...
  var today = (days[0]=="Mon")?1:(days[0]=="Feb")?2:(days[0]=="Wed")?3:(days[0]=="Thu")?4:(days[0]=="Fri")?5:(days[0]=="Sat")?6:(days[0]=="Sun")?7:0;
  var i,j;
 
  document.writeln('<h3 style="color:#3973ac;">北海道 Hokkaido</h3><hr>');

  document.writeln('<h3 style="color:#3973ac;font-size: 14px;">(' + days[0] +') '+ dates[0] + ' ' + months[0] + ' : '+ lows[0] + ' ~ '+ highs[0] + ' Celsius <br>' + conds[0] + '<br>' + cond +'</h3>');
