jQuery(document).ready(function($) {
  ...
  url : "http://api.wunderground.com/api/1e87c7e6b0a2bb1e/forecast10day/q/Japan/Kagoshima-shi.json",
  dataType : "jsonp",
  ...
  document.writeln('<h3 style="color:#ff9966;">鹿児島 Kagoshima</h3><hr>');

  document.writeln('<h3 style="color:#ff9966;font-size: 14px;">(' + days[0] +') '+ dates[0] + ' ' + months[0] + ' : '+ lows[0] + ' ~ '+ highs[0] + ' Celsius <br>' + conds[0] + '<br>' + cond +'</h3>');
  ...
  document.writeln('<p style="color:#ff9966;"> 特產： 鹿兒島黑豬, 鹿兒島黑毛和牛, 雞肉刺身 。。。 </p>');
