jQuery(document).ready(function($) {
  ...
  url : "http://api.wunderground.com/api/1e87c7e6b0a2bb1e/forecast10day/q/Japan/Fukuoka-shi.json",
  dataType : "jsonp",
  ...
  document.writeln('<h3 style="color:#ff9966;">福岡 Fukuoka</h3><hr>');
  ...
  document.writeln('<p style="color:#ff9966;"> 特產： 博多拉麵, 雞肉火鍋, 辛子明太子 。。。 </p>');
