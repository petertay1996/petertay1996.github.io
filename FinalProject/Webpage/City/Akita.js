jQuery(document).ready(function($) {
  ...
  url : "http://api.wunderground.com/api/1e87c7e6b0a2bb1e/forecast10day/q/Japan/Akita-shi.json",
  dataType : "jsonp",
  ...
  document.writeln('<h3 style="color:#0099cc;">秋田 Akita</h3><hr>');

  document.writeln('<h3 style="color:#0099cc;font-size: 14px;">(' + days[0] +') '+ dates[0] + ' ' + months[0] + ' : '+ lows[0] + ' ~ '+ highs[0] + ' Celsius <br>' + conds[0] + '<br>' + cond +'</h3>');
  ...
  document.writeln('<p style="color:#0099cc;"> 特產： 烤米棒火鍋, 比內地雞, 稻庭烏龍麵 。。。 </p>');
