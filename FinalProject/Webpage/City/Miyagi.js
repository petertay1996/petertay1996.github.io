jQuery(document).ready(function($) {
  ...
  url : "http://api.wunderground.com/api/1e87c7e6b0a2bb1e/forecast10day/q/Japan/Shimizu-koji.json",
  dataType : "jsonp",
  ...
  document.writeln('<h3 style="color:#0099cc;">宮城 Miyagi</h3><hr>');
  ...
  document.writeln('<p style="color:#0099cc;"> 特產： 牛舌, 中華涼麵 。。。 </p>');
