jQuery(document).ready(function($) {
  ...
  url : "http://api.wunderground.com/api/1e87c7e6b0a2bb1e/forecast10day/q/Japan/Osaka-shi.json",
  dataType : "jsonp",
  ...
  document.writeln('<h3 style="color:#cc0000;">大阪 Osaka</h3><hr>');
  ...
  document.writeln('<p style="color:#cc0000;"> 特產： 章魚燒, 螃蟹料理, 河豚火鍋 。。。 </p>');
