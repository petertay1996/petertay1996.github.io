jQuery(document).ready(function($) {
  ...
  url : "http://api.wunderground.com/api/1e87c7e6b0a2bb1e/forecast10day/q/Japan/Tokyo.json",
  dataType : "jsonp",
  ...
  document.writeln('<h3 style="color:#00cc00;">東京 Tokyo</h3><hr>');

  document.writeln('<h3 style="color:#00cc00;font-size: 14px;">(' + days[0] +') '+ dates[0] + ' ' + months[0] + ' : '+ lows[0] + ' ~ '+ highs[0] + ' Celsius <br>' + conds[0] + '<br>' + cond +'</h3>');
  ...
  document.writeln('<p style="color:#00cc00;"> 特產： 泥鰍火鍋 / 柳川火鍋, 蕎麥麵 。。。 </p>');
