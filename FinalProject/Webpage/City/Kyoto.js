jQuery(document).ready(function($) {
  ...
  url : "http://api.wunderground.com/api/1e87c7e6b0a2bb1e/forecast10day/q/Japan/Kyoto.json",
  dataType : "jsonp",
  ...
  document.writeln('<h3 style="color:#cc0000;">京都 Kyoto</h3><hr>');
  ...
  document.writeln('<p style="color:#cc0000;"> 特產： 懷石料理, 豆腐料理, 精進料理 。。。 </p>');
