jQuery(document).ready(function($) {
  ...
  url : "http://api.wunderground.com/api/1e87c7e6b0a2bb1e/forecast10day/q/Japan/Okinawa.json",
  dataType : "jsonp",
  ...
  document.writeln('<h3 style="color:#ff6666;">沖繩 Okinawa</h3><hr>');

  document.writeln('<h3 style="color:#ff6666;font-size: 14px;">(' + days[0] +') '+ dates[0] + ' ' + months[0] + ' : '+ lows[0] + ' ~ '+ highs[0] + ' Celsius <br>' + conds[0] + '<br>' + cond +'</h3>');
  ...
  document.writeln('<p style="color:#ff6666;"> 特產： 石垣牛肉, AGU豬, 海葡萄, 夜光貝 。。。 </p>');
  }
  });
});