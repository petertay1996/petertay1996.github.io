jQuery(document).ready(function($) {
  ...
  url : "http://api.wunderground.com/api/1e87c7e6b0a2bb1e/forecast10day/q/Japan/Shiojiri.json",
  dataType : "jsonp",
  ...
  document.writeln('<h3 style="color:#ffcc00;">長野 Nagano</h3><hr>');
  ...
  document.writeln('<p style="color:#ffcc00;"> 特產： 栗子料理, 野味鍋 。。。 </p>');
