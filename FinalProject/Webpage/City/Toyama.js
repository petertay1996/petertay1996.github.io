jQuery(document).ready(function($) {
  ...
  url : "http://api.wunderground.com/api/1e87c7e6b0a2bb1e/forecast10day/q/Japan/Toyama-shi.json",
  dataType : "jsonp",
  ...
  document.writeln('<h3 style="color:#ffcc00;">富山 Toyama</h3><hr>');

  document.writeln('<h3 style="color:#ffcc00;font-size: 14px;">(' + days[0] +') '+ dates[0] + ' ' + months[0] + ' : '+ lows[0] + ' ~ '+ highs[0] + ' Celsius <br>' + conds[0] + '<br>' + cond +'</h3>');
  ...
  document.writeln('<p style="color:#ffcc00;"> 特產： 富山灣壽司, 富山白蝦, 富山黑拉麵 。。。 </p>');
