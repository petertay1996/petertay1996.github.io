jQuery(document).ready(function($) {
  ...
  url : "http://api.wunderground.com/api/1e87c7e6b0a2bb1e/forecast10day/q/Japan/Nagasaki-shi.json",
  dataType : "jsonp",
  ...
  document.writeln('<h3 style="color:#ff9966;">長崎 Nagasaki</h3><hr>');
  ...
  document.writeln('<p style="color:#ff9966;"> 特產： 卓袱料理, 日式角煮包 。。。 </p>');
  }
  });
});