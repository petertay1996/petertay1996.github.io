jQuery(document).ready(function($) {
  ...
  url : "http://api.wunderground.com/api/1e87c7e6b0a2bb1e/forecast10day/q/Japan/Kochi-shi.json",
  dataType : "jsonp",
  ...
  document.writeln('<h3 style="color:#800060;">高知 Kochi</h3><hr>');

  document.writeln('<h3 style="color:#800060;font-size: 14px;">(' + days[0] +') '+ dates[0] + ' ' + months[0] + ' : '+ lows[0] + ' ~ '+ highs[0] + ' Celsius <br>' + conds[0] + '<br>' + cond +'</h3>');
