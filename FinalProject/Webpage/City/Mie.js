jQuery(document).ready(function($) {
  ...
  url : "http://api.wunderground.com/api/1e87c7e6b0a2bb1e/forecast10day/q/Japan/Mie-shi.json",
  dataType : "jsonp",
  ...
  document.writeln('<h3 style="color:#cc0000;">三重 Mie</h3><hr>');
  ...
  document.writeln('<p style="color:#cc0000;"> 特產： 松阪牛肉, 伊勢龍蝦 。。。 </p>');
