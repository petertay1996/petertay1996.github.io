jQuery(document).ready(function($) {
  ...
  url : "http://api.wunderground.com/api/1e87c7e6b0a2bb1e/forecast10day/q/Japan/Hiroshima-shi.json",
  dataType : "jsonp",
  ...
  document.writeln('<h3 style="color:#996633;">廣島 Hiroshima</h3><hr>');

  document.writeln('<h3 style="color:#996633;font-size: 14px;">(' + days[0] +') '+ dates[0] + ' ' + months[0] + ' : '+ lows[0] + ' ~ '+ highs[0] + ' Celsius <br>' + conds[0] + '<br>' + cond +'</h3>');
