jQuery(document).ready(function($) {
  ...
  url : "http://api.wunderground.com/api/1e87c7e6b0a2bb1e/forecast10day/q/Japan/Kumamoto-shi.json",
  dataType : "jsonp",
  ...
  document.writeln('<h3 style="color:#ff9966;">熊本 Kumamoto</h3><hr>');
  ...
  document.writeln('<p style="color:#0099cc;"> 特產： 馬肉刺身, 芥末蓮藕 。。。 </p>');
