jQuery(document).ready(function($) {
  ...
  url : "http://api.wunderground.com/api/1e87c7e6b0a2bb1e/forecast10day/q/Japan/Aichi.json",
  dataType : "jsonp",
  ...
  document.writeln('<h3 style="color:#ffcc00;">愛知 Aichi</h3><hr>');
  ...
  document.writeln('<p style="color:#ffcc00;"> 特產： 名古屋雞肉, 味增豬排, 鰻魚飯 。。。 </p>');
