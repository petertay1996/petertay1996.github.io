jQuery(document).ready(function($) {
  ...
  url : "http://api.wunderground.com/api/1e87c7e6b0a2bb1e/forecast10day/q/Japan/Nara-shi.json",
  dataType : "jsonp",
  ...
  document.writeln('<h3 style="color:#cc0000;">奈良 Nara</h3><hr>');
  ...
  document.writeln('<p style="color:#cc0000;"> 特產： 茶粥, 飛鳥火鍋, 柿葉壽司 。。。 </p>');
